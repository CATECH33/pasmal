  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex flex-col gap-3">
        <Button type="button" variant="outline" disabled={loading || sent} onClick={resend} className="w-full">
          {sent ? <><I.CheckCircle size={16}/> E-mail renvoyé</> : loading ? <><I.Loader size={16}/> Envoi…</> : <>Renvoyer l'e-mail de confirmation</>}
        </Button>
        <a href="https://mail.google.com" target="_blank" rel="noreferrer" className="text-center text-sm text-slate-600 hover:text-orange-600">
          Ouvrir Gmail →
        </a>
      </div>
    </AuthLayout>
